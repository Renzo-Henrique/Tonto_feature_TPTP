...
export function classElementTptpGenerator(classElement: ClassDeclaration, packageItem: Package): Class {
...
//TODO:: verificar
export function generalizationTptpGenerator(model: Package, sourceClass: Class, targetClass: Class) {
    model.createGeneralization(sourceClass, targetClass);
}
//TODO:: verificar
export function createTptpInstantiation(_model: Package, _sourceClass: Class, _targetClass: Class) {
