...
export function relationTptpGenerator(
    ...
    if (sourceClass && destinationClass) {
        ...
        targetEnd.setName(relationItem.secondEndMetaAttributes.endName);
            ...
            setPropertyCardinalityTptp(relationItem.firstCardinality, sourceEnd);
            setPropertyCardinalityTptp(relationItem.secondCardinality, targetEnd);
...
export function relationGeneralizationTptpGenerator(model: Package, sourceRelation: Relation, targetRelation: Relation) {
