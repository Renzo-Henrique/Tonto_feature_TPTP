...
import { GeneratedContextTptpModuleData, contextTptpModuleGenerateClasses, contextTptpModuleGenerateRelations, contextModuleTptpModularGenerator } from "./contextModuleTptpModular.generator.js";
...
export function parseProjectTptp(ctx: GeneratorTptpContext): Project {
   ...
   */
    for (const model of ctx.models) {
        ...
        const GeneratedContextTptpModuleData = contextTptpModuleGenerateClasses(contextModule, createdPackage);
   ...
   */
    ctx.models.forEach((model) => {
        ...
        if (createdPackage && generatedContextModelData) {
            contextTptpModuleGenerateRelations(model.module, createdPackage, generatedContextModelData, [
                ...importedDataTypes,
                ...globalDataTypes,
            ]);
        }
