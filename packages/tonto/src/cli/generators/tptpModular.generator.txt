...
export function generateTptpFileModular(
    ...
    const ctx = <GeneratorContextTptp>{
        models,
...
export interface GeneratorContextTptp {
    models: Model[]
    manifest: TontoManifest
...
function generate(ctx: GeneratorContextTptp): string {
    /**
   ...
   */
    ...
    //TODO:: Mudar esse trecho para gerar o correto 
...
export function parseProject(ctx: GeneratorContextTptp): Project {
