...
export const validateByTptpCommand = async (dirName: string, locally: boolean = false): Promise<ValidationReturn | ErrorResultResponse> => {
    ...
    try {
        ...
        if (isValidationByTptpReturn(validationResult)) {
...
function isValidationByTptpReturn(object: any): object is ValidationReturn {
